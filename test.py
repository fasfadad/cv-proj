...
def recommend():
    ...
    root.title("Hotel Recommendation")
...
def main_screen(root): 
    ...
    Button(mainframe,text="Get Recommendations", font=("loma", 14, 'bold'), cursor='hand2', height="2",width=20,bg="#d7dae2",bd=4,command=recommend).place(x=50,y=170)
    Button(mainframe,text="View list of Hotels", font=("loma", 14, 'bold'), cursor='hand2', height="2",width=20,bg="#d7dae2",bd=4,command=recommend).place(x=500,y=170)
    screen.mainloop()
